...
case $SERVER in
	red01)
		...
		BASECORE=0; MAXCORES=4; OTHER="6-11"; MUTCORES=12; QPS="100000 150000 200000 250000"
		;;
	red01vm)
		IFACE=enp7s0; SERVER_IP=10.10.0.1; DRIVER=red02; CLIENTS=red03,red04,red05,red06,red08,red09
		BASECORE=0; MAXCORES=4; OTHER="5-6"; MUTCORES=12; QPS="100000 150000 200000"
		;;
	tilly01) # mlx5
		IFACE=ens2f1np1; SERVER_IP=192.168.199.1; DRIVER=tilly02; CLIENTS=tilly03,tilly04,tilly05,tilly06,tilly07,tilly08
		BASECORE=0; MAXCORES=8; OTHER="8-15"; MUTCORES=16; QPS="200000 400000 600000 800000"
		;;
	tilly02) # mlx4
	...
	node10)
		...
		BASECORE=0; MAXCORES=8; OTHER="8-9"; MUTCORES=10; QPS="200000 400000 600000 800000 1000000"
		MUTILATE="./mutilate"
		;;
	*)
